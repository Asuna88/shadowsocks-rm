...
yum install -y python-m2crypto build-essential supervisor python-pip || { apt-get update;apt-get install -y wget python-m2crypto build-essential supervisor python-pip } || { echo "依赖库没安装成功，程序暂停";exit 1; }
